...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Andreea Store!</h1>
           ...
           <footer class="footer">
               <div class="container">
                   <center>
                       <p>Copyright &copy Andreea Store. All Rights Reserved.</p>
                       <p>This website is developed by Vechiu Andreea</p>
                   </center>
               </div>
           </footer>
        </div>
